...
`eval-gdm_self_proliferation` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/gdm_self_proliferation`)
...
- `git_clone`: `https://github.com/mistralai/mistral-src.git`
- `direct_url`: `https://files.mistral-7b-v0-1.mistral.ai/mistral-7B-v0.1.tar`
- `direct_url`: `pip install git+https://github.com/huggingface/{transformers,peft,accelerate}.git`
- `direct_url`: `https://raw.githubusercontent.com/UKGovernmentBEIS/inspect_evals/{version}/...secrets.zip`
