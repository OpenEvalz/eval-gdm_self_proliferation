#!/usr/bin/env python3
"""Run ONE problem of gdm_self_proliferation through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/gdm_sp01_e2e"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one gdm_self_proliferation problem via TrustedRouter")
